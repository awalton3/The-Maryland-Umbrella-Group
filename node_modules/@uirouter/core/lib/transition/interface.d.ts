...
export interface IHookRegistry {
     ...
     * #### Audit Log
     *
     * This example uses a service to log that a user has entered the TUTOR section of an app.
     * This assumes that there are substates of the "TUTOR" state, such as "TUTOR.users", "TUTOR.pages", etc.
     * @example
     * ```
     *
     * $transitions.onEnter({ entering: 'TUTOR' }, function(transition, state) {
...
export declare type IStateMatch = Predicate<StateObject>;
/**
