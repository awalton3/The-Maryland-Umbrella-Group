            ...
            controller: [
                ...
                function ($scope, $element, $attrs) {
                    ...
                    function setStatesFromDefinitionObject(statesDefinition) {
                        if (core_1.isObject(statesDefinition)) {
                            states = [];
                            core_1.forEach(statesDefinition, function (stateOrName, activeClass) {
                                ...
                                else if (core_1.isArray(stateOrName)) {
                                    // If state is an array, iterate over it and add each array item individually.
                                    core_1.forEach(stateOrName, function (stateOrName) {
                                        addStateForClass(stateOrName, activeClass);
                                    });
                                }
                            });
                    ...
                    // Update route state
                    function update() {
                        var splitClasses = function (str) { return str.split(/\s/).filter(core_1.identity); };
