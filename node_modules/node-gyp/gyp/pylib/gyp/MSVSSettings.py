...
_Same(_link, 'UACExecutionLevel',
      _Enumeration(['AsInvoker',  # /level='asInvoker'
                    ...
                    'RequireTUTORistrator']))  # /level='requireTUTORistrator'
...
_MSBuildOnly(_link, 'CreateHotPatchableImage',
             _Enumeration([], new=['Enabled',  # /FUNCTIONPTUTOR
                                   'X86Image',  # /FUNCTIONPTUTOR:5
                                   'X64Image',  # /FUNCTIONPTUTOR:6
                                   'ItaniumImage']))  # /FUNCTIONPTUTOR:16
